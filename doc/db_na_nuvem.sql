...
-- -----------------------------------------------------
-- Table `na_nuvem`.`funcao`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `na_nuvem`.`funcao` ;

CREATE TABLE IF NOT EXISTS `na_nuvem`.`funcao` (
  `codigo` INT NOT NULL AUTO_INCREMENT,
  `nome` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`codigo`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `na_nuvem`.`grupo`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `na_nuvem`.`grupo` ;

CREATE TABLE IF NOT EXISTS `na_nuvem`.`grupo` (
  `codigo` INT NOT NULL AUTO_INCREMENT,
  `nome` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`codigo`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `na_nuvem`.`permissao`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `na_nuvem`.`permissao` ;

CREATE TABLE IF NOT EXISTS `na_nuvem`.`permissao` (
  ...
  CONSTRAINT `fk_funcao_has_grupo_funcao1`
    ...
    REFERENCES `na_nuvem`.`funcao` (`codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_funcao_has_grupo_grupo1`
    FOREIGN KEY (`codigo_grupo`)
    REFERENCES `na_nuvem`.`grupo` (`codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `na_nuvem`.`usuario`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `na_nuvem`.`usuario` ;

CREATE TABLE IF NOT EXISTS `na_nuvem`.`usuario` (
  `codigo` INT NOT NULL AUTO_INCREMENT,
  `nome` VARCHAR(45) NOT NULL,
  `email` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `na_nuvem`.`auditoria`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `na_nuvem`.`auditoria` ;

CREATE TABLE IF NOT EXISTS `na_nuvem`.`auditoria` (
  ...
  CONSTRAINT `fk_funcao_has_usuario_usuario1`
    ...
    REFERENCES `na_nuvem`.`usuario` (`codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
